...
_lr_productions = [
  ...
  ('statement -> expression SEMICOLON','statement',2,'p_statement_expression','parser.py',32),
  ('statement_list -> statement','statement_list',1,'p_statement_list','parser.py',37),
  ('statement_list -> statement statement_list','statement_list',2,'p_statement_list','parser.py',38),
  ('expression_list -> expression','expression_list',1,'p_expression_list','parser.py',46),
  ('expression_list -> expression_list COMMA expression','expression_list',3,'p_expression_list','parser.py',47),
  ('statement -> ID ASSIGN expression SEMICOLON','statement',4,'p_statement_assign','parser.py',55),
  ('statement -> ID PLUSASSIGN expression SEMICOLON','statement',4,'p_statement_assign_op','parser.py',60),
  ('statement -> ID MINUSASSIGN expression SEMICOLON','statement',4,'p_statement_assign_op','parser.py',61),
  ...
  ('expression -> expression EQUAL expression','expression',3,'p_expression_comparison','parser.py',77),
  ('expression -> expression NOTEQUAL expression','expression',3,'p_expression_comparison','parser.py',78),
  ('expression -> expression LESS expression','expression',3,'p_expression_comparison','parser.py',79),
  ('expression -> expression MORE expression','expression',3,'p_expression_comparison','parser.py',80),
  ('expression -> expression OR expression','expression',3,'p_expression_or','parser.py',85),
  ('expression -> expression AND expression','expression',3,'p_expression_and','parser.py',90),
  ('statement -> IF LPAREN expression RPAREN LBRACE statement_list RBRACE elif_blocks ELSE LBRACE statement_list RBRACE','statement',12,'p_statement_if','parser.py',95),
  ('statement -> IF LPAREN expression RPAREN LBRACE statement_list RBRACE elif_blocks','statement',8,'p_statement_if','parser.py',96),
  ('statement -> IF LPAREN expression RPAREN LBRACE statement_list RBRACE ELSE LBRACE statement_list RBRACE','statement',11,'p_statement_if','parser.py',97),
  ('statement -> IF LPAREN expression RPAREN LBRACE statement_list RBRACE','statement',7,'p_statement_if','parser.py',98),
  ('elif_blocks -> ELIF LPAREN expression RPAREN LBRACE statement_list RBRACE elif_blocks','elif_blocks',8,'p_statement_elif_blocks','parser.py',112),
  ('elif_blocks -> ELIF LPAREN expression RPAREN LBRACE statement_list RBRACE','elif_blocks',7,'p_statement_elif_blocks','parser.py',113),
  ('statement -> DO LBRACE statement_list RBRACE','statement',4,'p_statement_do','parser.py',123),
  ('statement -> DO LBRACE statement_list RBRACE WHILE LPAREN expression RPAREN SEMICOLON','statement',9,'p_statement_do_while','parser.py',128),
  ...
  ('expression -> ID','expression',1,'p_expression_id','parser.py',143),
  ('statement -> PRINT LPAREN expression_list RPAREN SEMICOLON','statement',5,'p_statement_print','parser.py',148),
]
